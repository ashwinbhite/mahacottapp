...
public class FutureAuctionSubmision extends Activity implements
        HttpResponseListener<JSONObject>, OnItemSelectedListener, TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_future_auction_submision);
        ...
        saleTypeList.add("Future Sale");


        saleTypeMap.put("Future Sale", "F");
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if(!hasFocus){
                    if(gradeTypeList.contains(actGrade.getText().toString()))
                        System.out.println("grade selected");
                    else
                    {
                                ...
                                public void getResponse(JSONObject response) {
                                    ...
                                    try {
                                        ...
                                        if(response.getString("msg").equalsIgnoreCase("SUCCESS")){
                                            ...
                                            int stockPending =Integer.parseInt(jsonObj.getString("STOCK"));
                                            int enteredQty = Integer.parseInt(edtQty.getText().toString());
...
//        TextView heapNoColumnLabel = new TextView(getApplicationContext()) {
//        };
...
//                R.drawable.cell_border));
        heapNoColumnLabel.setBackground(getResources().getDrawable(R.drawable.cell_border));
        ...
        for (int i = 0; i < gridvarietyDesclist.size(); i++) {
        ...
        alertDialogBuilder.setPositiveButton("yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        SeedStockEntryService seedStockEntryService = new SeedStockEntryService(
                                getApplicationContext());
                        seedStockEntryService.submitSeedStockEntry("0",
                                btnCurrentDate.getText().toString(),
                                commoMstId, varietyMstID, gradeId,
                                strQuantity, seasonMstId, strOilPercent,
                                strMoisture, strHeapNo, saleTypeMap.get(strSaleType),
    ...
    public void getSeedStockEntry(){
        ...
        SeedStockEntryService seedStockEntryService = new SeedStockEntryService(getApplicationContext());
        seedStockEntryService.getSeedStockEntry(btnCurrentDate.getText().toString(),"F", new HttpResponseListener<JSONObject>() {
